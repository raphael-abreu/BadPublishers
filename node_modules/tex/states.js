...
var TEX = (function (_super) {
    ...
    TEX.prototype.pop = function () {
        ...
        for (var i = 0, node = void 0; (node = children[i]); i++) {
...
var BibTeXEntryCaptureState = (function (_super) {
    ...
    BibTeXEntryCaptureState.prototype.pushBibTeXEntry = function () {
        var _this = this;
        var _a = this.attachState(BIBTEX_ENTRY).read(), pubtype = _a.pubtype, citekey = _a.citekey, unresolvedFields = _a.fields;
        var fields = unresolvedFields.map(function (_a) {
            var name = _a[0], unresolvedValue = _a[1];
            var fieldValueString = unresolvedValue.toString(_this.stringVariables);
        ...
        this.value.push({ pubtype: pubtype, citekey: citekey, fields: fields });
        return undefined;
    };
